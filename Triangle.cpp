...
Triangle::Triangle(Point pt1, Point pt2, Point pt3, Color color) {
	vertexOne = Point(pt1);
	vertexTwo = Point(pt2);
	vertexThree = Point(pt3);
	vertexOneColor = Color(color);
	vertexTwoColor = Color(color);
	vertexThreeColor = Color(color);
}
Triangle::Triangle(Point pt1, Color color1, Point  pt2, Color color2, Point pt3, Color color3) {
	vertexOne = Point(pt1);
	vertexTwo = Point(pt2);
	vertexThree = Point(pt3);
	vertexOneColor = Color(color1);
	vertexTwoColor = Color(color2);
	vertexThreeColor = Color(color3);
}
...
void Triangle::write(ostream& outs) {
	Point write(vertexOne);
	Color write(vertexOneColor);
	Point write(vertexTwo);
	Color write(vertexTwoColor);
	Point write(vertexThree);
	Color write(vertexThreeColor);
}
